#  To do: 
#  1. Get user feedback, and store information in a more efficient way
#  2. the filesearch and revise of the microwave plan is not so accuate for now,
#     still need to test more with different data and revised plans. 

#  Current Update:
#  1. only replying with json (originally it will sometimes add a text at the beginning)
